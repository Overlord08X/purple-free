...
Route::middleware(['auth', 'check.session'])->group(function () {
    ...
    Route::post('/vendor/menu', [projectController::class, 'storeMenu'])->name('project.vendor.menu.store');
    ...
    Route::get('/kantin/item/{kode}', [kantinController::class, 'getItem'])->name('kantin.item');
