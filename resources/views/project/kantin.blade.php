            ...
            <div class="card-body">
                ...
                <div class="table-responsive mb-4">
                    <table class="table table-sm table-hover" id="tableBarang">
                        ...
                        <tbody> @foreach($barangs as $barang) <tr>
                                <td>{{ $barang->idbarang }}</td>
                                <td>{{ $barang->nama_barang }}</td>
                                <td>Rp {{ number_format($barang->harga_barang, 0, ',', '.') }}</td>
                                <td> <button class="btn btn-sm btn-primary pilih-barang" data-kode="{{ $barang->idbarang }}" data-nama="{{ $barang->nama_barang }}" data-harga="{{ $barang->harga_barang }}"> Pilih </button> </td>
                            </tr> @endforeach </tbody>
                    </table>
                </div>
                <div class="row mb-3">
                    <div class="col-md-2"> <input type="text" id="idBarang" class="form-control" placeholder="Kode Barang"> </div>
                    <div class="col-md-3"> <input type="text" id="namaBarang" class="form-control" readonly placeholder="Nama Barang"> </div>
